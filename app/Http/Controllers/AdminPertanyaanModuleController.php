<?php namespace App\Http\Controllers;
	...
	class AdminPertanyaanModuleController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
			...
			$this->index_statistic[] = ['label'=>'Total Data','count'=>DB::table('tbl_pertanyaan')->count(),'icon'=>'fa fa-check','color'=>'success'];
	        ...
	        */
	        ...
	        ";
	  		// $(function() {
			//     $('input[name=\'bebas[]\']').change(function() {
			//         if($(this).is(':checked')) {
			//             $('#form-group-id_opsi').toggle('300');
			//         }else{
			//         	$('#form-group-id_opsi').toggle('300');				        	
			//         }
			//     });
