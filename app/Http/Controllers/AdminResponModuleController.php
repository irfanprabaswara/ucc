<?php namespace App\Http\Controllers;
	...
	class AdminResponModuleController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Informan","name"=>"id_informan","join"=>"tbl_informan,nama"];
			$this->col[] = ["label"=>"Created At","name"=>"created_at"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Informan','name'=>'id_informan','type'=>'select2','validation'=>'required|min:0','width'=>'col-sm-10','datatable'=>'informan,id'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Informan','name'=>'id_informan','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'informan,id'];
			# OLD END FORM
	        ...
	        */
	        ...
	        |
	        */
	        $this->index_button = array(array('label' => $this->showResponses->is_show?'Show Response (Current: Showed)':'Show Response (Current: Hidden)', 'url' => 'toggle_show/', 'icon' => 'fa fa-eye'));
	    ...
	    public function getIndex(){
					...
					if ($pertanyaan->id_opsi != 0 && !(is_null($pertanyaan->id_opsi))) {
						...
						foreach ($pertanyaan->opsi->opsi_list as $opsi) {
							if ($opsi->respon_list_count->isEmpty()) {
								$respon->addRow(array($opsi->nama_list => 0));
			...
			$data['page_title'] = 'Show Respond';
			$data['result'] = $colors;

			//Create a view. Please use `cbView` method instead of view method from laravel.
			$this->cbView('show_respon', $data);
	    }
