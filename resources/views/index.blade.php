    ...
    <div id="promo-slider" class="slider flexslider">
        <ul class="slides">
            @forelse($slider as $item)
                <li>
                    <img height="350" src="{{url($item->slider_url)}}"  alt="{{$item->slider_title}}" />
                    <p class="flex-caption">
                        <span class="main" >{{$item->slider_title}}</span>
                        <br />
                        <span class="secondary clearfix" >{{$item->slider_description}}</span>
                    </p>
                </li>
            @empty
