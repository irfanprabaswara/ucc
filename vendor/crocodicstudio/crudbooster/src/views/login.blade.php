  ...
  <head>
    ...
    <style type="text/css">
      .login-page, .register-page {
          background: {{ CRUDBooster::getSetting("login_background_color")?:'#56A8FF'}} url('{{ CRUDBooster::getSetting("login_background_image")?asset(CRUDBooster::getSetting("login_background_image")):asset('vendor/crudbooster/assets/bg_blur3.jpg') }}');
  ...
  <body class="login-page">
    ...
    <div class="login-box">
      <div class="login-logo">
        <a href="{{url('/')}}">
            <img title='{!!(CRUDBooster::getSetting('appname') == 'CRUDBooster')?"<b>CRUD</b>Booster":CRUDBooster::getSetting('appname')!!}' src='{{asset('images/ucc-direct/direct-01.png') }}' style='max-width: 100%;max-height:170px'/>
        </a>
      </div><!-- /.login-logo -->      
