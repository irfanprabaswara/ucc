...
<head>
    ...
    <meta name="author" content="Izzun Abdussalam">
...
<div class="wrapper">  
    <header class="main-header">
        <a href="<?php echo site_url('crud/index') ?>" class="logo">
           <span class="logo-mini"><b>UCC</b>b></span>
           <span class="logo-lg"><b>UCC</b>Database</span>
        </a>
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
            <b>Undip Career Center 
        </div>
        <strong>Copyright &copy; 2017 <a href="www.instagram.com/izzunabdussalam">Izzun Abdussalam</a>.</strong> All rights reserved.
    </footer>
</div><!-- ./wrapper -->
