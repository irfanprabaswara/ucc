...
class Examples extends CI_Controller {
	...
	public function perusahaan_management()
	{
		try{
			...
			$crud->required_fields('nama_informan');
			$crud->columns('nama_informan','jabatan_informan','email_informan','telepon_informan','nama_perusahaan');

						
			$output = $crud->render();

			$data['judul'] = 'Perusahaan';
			$data['crumb'] = array( 'Perusahaan' => '' );
	...
	public function offices_management()
	{
		try{
			...
			$crud->required_fields('nama_perusahaan','nama_informan','jabatan_informan');
			$crud->columns('nama_perusahaan','nama_informan','jabatan_informan','email_informan','telepon_informan','file','last_update');

			$crud->set_field_upload('file','assets/uploads/files', 'pdf');
			$crud->fields('nama_informan', 'jabatan_informan', 'email_informan','telepon_informan' ,'nama_perusahaan', 'email_perusahaan', 'telepon_perusahaan');			
			$output = $crud->render();
